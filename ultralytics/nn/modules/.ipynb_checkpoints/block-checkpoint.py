...
class CSPSWC(nn.Module):
    def __init__(self, dim, n=1, kernel_size=13, shortcut=False, g=1, e=0.5):
        super().__init__()
        self.e = e
        self.cv1 = Conv(dim, dim, 1)
        self.cv2 = Conv(dim, dim, 1)
        self.m = Bottleneck_SWC(int(dim * self.e),int(dim * self.e),kernel_size, shortcut, g, k=(3, 3), e=1.0)
